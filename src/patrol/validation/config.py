...
PATROL_TASK_WEIGHT = os.getenv('PATROL_TASK_WEIGHT', 80)
HOTKEY_OWNERSHIP_TASK_WEIGHT = os.getenv('HOTKEY_OWNERSHIP_TASK_WEIGHT', 20)

TASK_WEIGHTS = {
    "PatrolSynapse": PATROL_TASK_WEIGHT,
    "HotkeyOwnershipSynapse": HOTKEY_OWNERSHIP_TASK_WEIGHT,
}
