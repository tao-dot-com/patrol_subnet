...
HOTKEY_OWNERSHIP_TASK_WEIGHT = int(os.getenv('HOTKEY_OWNERSHIP_TASK_WEIGHT', 50))
PREDICT_ALPHA_SELL_TASK_WEIGHT = int(os.getenv('PREDICT_ALPHA_SELL_TASK_WEIGHT', 50))
